...
```
**Objective:** Retrieve movies based on a particular release year.
...
LIMIT 5;
```
**Objective:** Identify countries contributing the most content.
...
```
**Objective:** Determine the movie with the longest runtime.

---

### 6. Count the Number of Content Items Added Each Year
```sql
SELECT 
    release_year, 
    COUNT(*) AS total_content
...
```
**Objective:** Understand content trends over time.
...
```
**Objective:** Retrieve all content items by a given director.
...
```
**Objective:** Identify TV shows with a high number of seasons.
